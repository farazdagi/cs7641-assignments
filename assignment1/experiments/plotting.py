...
def summary_plot(output_file):
    ...
    flatui = ["#e17701", "#738595", "#658cbb", "#7af9ab", "#9b59b6", "#3498db", "#95a5a6", "#e74c3c", "#34495e",
              "#2ecc71"]
    sns.palplot(sns.color_palette(flatui))
    g = sns.catplot(x="class", y="value", hue="metric", data=summary_data,
                    height=6, kind="bar", palette=sns.color_palette(flatui))
...
if __name__ == '__main__':
    summary_plot('summary_plot_htru.png')
    exit(1)
